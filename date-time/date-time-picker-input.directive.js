...
exports.OwlDateTimeInputDirective = exports.OWL_DATETIME_VALIDATORS = exports.OWL_DATETIME_VALUE_ACCESSOR = void 0;
...
var OwlDateTimeInputDirective = function () {
  function OwlDateTimeInputDirective(elmRef, renderer, dateTimeAdapter, dateTimeFormats) {
    ...
    this.rangeSeparator = '~';
    this._values = [];
    this.dateTimeChange = new _core.EventEmitter();
    this.dateTimeInput = new _core.EventEmitter();
    this.dtPickerSub = _rxjs.Subscription.EMPTY;
    ...
    this.validator = _forms.Validators.compose([this.parseValidator, this.minValidator, this.maxValidator, this.filterValidator, this.rangeValidator]);
    this.valueChange = new _core.EventEmitter();
    this.disabledChange = new _core.EventEmitter();
  ...
  Object.defineProperty(OwlDateTimeInputDirective.prototype, "disabled", {
    ...
    set: function set(value) {
      var newValue = (0, _coercion.coerceBooleanProperty)(value);
  ...
  OwlDateTimeInputDirective.prototype.handleKeydownOnHost = function (event) {
    if (event.altKey && event.keyCode === _keycodes.DOWN_ARROW) {
      this.dtPicker.open();
