...
exports.OwlMultiYearViewComponent = exports.YEAR_ROWS = exports.YEARS_PER_ROW = void 0;
...
var OwlMultiYearViewComponent = function () {
  function OwlMultiYearViewComponent(cdRef, pickerIntl, dateTimeAdapter) {
    ...
    this.yearSelected = new _core.EventEmitter();
  ...
  OwlMultiYearViewComponent.prototype.createYearCell = function (year) {
    ...
    return new _calendarBody.CalendarCell(year, year.toString(), ariaLabel, this.isYearEnabled(year), false, cellClass);
  };
